...
public class SmartCard_Driver
{
   public static void main(String[] args) 
   {
      ...
      /* test cases:
      SmartCard tester = new SmartCard(4.96);
      tester.board(downtown);
      tester.exit(center);
      tester.exit(suburbia);
      tester.board(center);
      tester.board(center);
      tester.exit(suburbia);
      tester.board(suburbia);
      tester.exit(downtown);
      tester.addMoney(10.00);
      tester.exit(downtown);
      
      SmartCard tester2 = new SmartCard(1.00);
      tester2.board(center);
      tester2.exit(center);
      System.out.println("getBoardedAt(): " + tester2.getBoardedAt());
      */
